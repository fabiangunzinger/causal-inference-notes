...
- In general, as @hayashi2011econometrics points out, "a model is a set of joint distributions satisfying a set of assumptions".

Classical linear regresison model
...
- Based on [this](https://github.com/erykml/medium_articles/blob/master/Statistics/linear_regression_assumptions.ipynb)
