...
- What is objective here? -- If necessary, spell out loud to get confirmation.

- Problem type: what kind of problem am I dealing with? Descriptive? Predictive? Causal inference? - State out loud to get confirmation.

- Definitions: understand all the key contepts relevant to the question? (Metric, feature, product, user segment, etc.) - State these explicitly to get confirmation 

- What are my implicit assumptions?
...
- Eliminate irrelevant data
  - Should I focus on all customers or just on Region X?

Assume -- narrow down the problem.

- Make assumptions that make the problem concrete and solveable.

- Have the stakeholder confirm those assumptions so you're on the same page.
